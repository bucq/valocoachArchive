...
export async function analyzeThumbnailAnthropic(imageData, frames, apiKey, title) {
    ...
    try {
        ...
        const toolUse = data.content.find((b) => b.type === 'tool_use' && b.name === 'extract_valorant_metadata');
 ...
 */
function buildPerRequestContent(imageData, frames, title) {
    const content = [];
