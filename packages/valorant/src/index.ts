...
export const MAP_ICONS: Record<string, string> = {
  ...
  Corrode:  'https://media.valorant-api.com/maps/1c18ab1f-420d-0d8b-71d0-77ad3c439115/listviewicon.png',
};
...
export const RANK_ALIAS_MAP = new Map<string, string>(
  RANKS.flatMap(r => [[r.id.toLowerCase(), r.label], [r.label.toLowerCase(), r.label]]),
);
